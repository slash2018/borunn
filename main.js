...
global.owner = ['556599202754@s.whatsapp.net'] // Put your number here
global.mods = ['556599202754@s.whatsapp.net'] // Want some help?
global.prems = ['556599202754@s.whatsapp.net'] // Premium user has unlimited limit
...
if (opts['test']) {
  conn.user = {
    jid: '556599202754@s.whatsapp.net',
    name: 'borunn',
    phone: {}
  }
