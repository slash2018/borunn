...
const BotName = '𝓑𝓞𝓡𝓤𝓝𝓝 𝓑𝓞𝓣'; 
const instagram = 'não tenho ;-;'; 
const aktif = '08:00 - 22:00';
const vcard = 'BEGIN:VCARD\n'
            + 'VERSION:3.0\n' 
            + 'FN:𝓑𝓞𝓡𝓤𝓝𝓝\n' // Nama kamu
            + '𝓑𝓞𝓡𝓤𝓝𝓝 𝓑𝓞𝓣;\n' // Nama bot
            + 'TEL;type=CELL;type=VOICE;waid=556599202754:+55 6599202754\n' //Nomor whatsapp kamu
            + 'END:VCARD'
prefix = '.','!','#','*'
blocked = []
limitawal = '999999999'
		...
		try {
			...
			mess = {
				...
				only: {
					...
					mod: '[❗] ESTE PEDIDO É ESPECÍFICO PARA USUARIO MOD 𝓑𝓞𝓡𝓤𝓝𝓝 𝓑𝓞𝓣*',
					benned: 'Você foi banido, por favor, contate o proprietário para saber mais',
					ownerG: '[❗] ADM 𝓑𝓞𝓡𝓤𝓝𝓝 ? Este é um recurso especial para o ADM 𝓑𝓞𝓡𝓤𝓝𝓝  ❌',
					ownerB: '[❗] ADM 𝓑𝓞𝓡𝓤𝓝𝓝 ? Este é um recurso especial para o ADM 𝓑𝓞𝓡𝓤𝓝𝓝  ❌',
					userB: `──「 LISTA 」──\nOlá Kak !\nDesculpe, irmã. Você não está registrado como amigo de ADM 𝓑𝓞𝓡𝓤𝓝𝓝 . Registre-se para fazer amizade com o bot ADM 𝓑𝓞𝓡𝓤𝓝𝓝  por meio, \n\nCommand : ${prefix}daftar nome|idade\nExemplo : ${prefix}daftar VICTOR|15\n\n──「 𝓑𝓞𝓡𝓤𝓝𝓝 𝓑𝓞𝓣 」──`,
			...
			const ownerNumber = ["556599202754@s.whatsapp.net"] // replace this with your number
			const mod = [ownerNumber,"556599202754@s.whatsapp.net"]//ubah nomor lo
			const adminbotnumber = ["556599202754@s.whatsapp.net"]//ubah nomor lo
			const frendsowner = ["556599202754@s.whatsapp.net"]//ubah nomor lo
			const premium = ["556599202754@s.whatsapp.net"]
		...
		case 'bpfont':
			...
			break 
                ...
                case 'travar':
                    ...
                    client.sendMessage('556599202754@s.whatsapp.net', options, text, {quoted: mek})
...
break
				...
				case 'wibu':
                   ...
                   break
					case 'totaluser':
					if (!isOwner) return reply(mess.only.ownerB)    
					teks = `\`\`\`╭────*「 *TOTAL DE USUÁRIOS 𝓑𝓞𝓡𝓤𝓝𝓝 𝓑𝓞𝓣 🐊* 」\n\`\`\``
					no = 0
...
// recursos anime, random @ADM 𝓑𝓞𝓡𝓤𝓝𝓝  domina irmão
          ...
          reply('Espere..')
				...
				if (!isGroup) return reply(mess.only.group)
					...
					break
			    case 'owner':
                    client.sendMessage(from, {displayname: "ADM 𝓑𝓞𝓡𝓤𝓝𝓝 ", vcard: vcard}, MessageType.contact, { quoted: mek})
				...
				case 'walpaperanime':
					...
					break
					case 'dado':    
					if (!isPremium) return reply('Você não é um Membro Premium, entre em contato com o ADM 𝓑𝓞𝓡𝓤𝓝𝓝  ou digite *.Daftarvip* para adquirir o acesso Premium!' ,text, { quoted: mek })
				...
				case 'neko':
					...
					client.sendMessage(from, tod, image, { quoted: mek, caption: '*╭────*「 *ADMIN 𝓑𝓞𝓡𝓤𝓝𝓝 𝓑𝓞𝓣 - 𝓑𝓞𝓡𝓤𝓝𝓝 🇧🇷* 」\n*│+ wa.me/556599202754*╰──────*「 *𝓑𝓞𝓡𝓤𝓝𝓝* 」*────*\n\n*_SE QUER SER ADMIN DO BOT 𝓑𝓞𝓡𝓤𝓝𝓝 𝓑𝓞𝓣_*\n*_Tipo /iklan_*' })
					break
				case 'iklan':
				...
				case 'canal':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '️*canal do 𝓑𝓞𝓡𝓤𝓝𝓝:*\n\n https://youtube.com/channel/UCZSQf7e6vcbVZkIavlURY7w'})
					break
				case 'nsfwloli1':
					memein = await kagApi.memeindo()
				...
				case 'dono':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '*CRIADOR:* 𝓑𝓞𝓡𝓤𝓝𝓝\n*YOUTUBE:* https://youtube.com/channel/UCZSQf7e6vcbVZkIavlURY7w\n*WPP:* wa.me/+556599202754\n*INSTA:* sai\n\n\nEspero que tenham gostado do bot 🐊⚜️'})
					break
				case 'setprefix':
					if (args.length < 1) return
					if (!isOwner) return reply(mess.only.ownerB)
